...
@router.get("/edit_text/{public_id}")
...
@router.post("/actions/edit_text/{public_id}")
...
async def login_validation(
    ...
    resp.set_cookie("session", session_serializer.dumps({"is_logged_in": True}), max_age=max_age)  # type: ignore  # noqa: E501
